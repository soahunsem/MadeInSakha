...
$q = mysqli_query($c, "SELECT * FROM korz WHERE id_pok='{$_SESSION['id_pok']}'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div style="text-align: center;">
    <p style="text-decoration: none; font-family: gl; font-size: 7vh; margin-top: 20vh; height: 3vh; margin-bottom: 5vh">Корзина <img src="../img/aaa.png"></p>
</div>
...
<div style="margin-top: 15vh; width: 60%; display: flex; flex-direction: column;" class="marg">
    ...
    for ($i=0; $i < mysqli_num_rows($q); $i++) {
        ...
        $ss = $qq->fetch_assoc();
        ?>
        <div style="width: 100%; display: flex; justify-content: center; height: 20vh;">
            ...
            <a href="../utilites/delete.php?id=<?php echo $s['id_lol'] ?>" style="width: 10vh; height: 20vh; margin-top: 9vh; font-size: 2.5vh"><img src="../img/katalog/krest.png" style="width: 3vh; height: 3vh; margin-top: 0vh; margin-left: 2.5vh" class="kr"></a>
        </div>
        <?php
    }
    ?>
...
<div>
    <span style="margin-left:100px;margin-top: 200px ">Вам может понравиться</span>
